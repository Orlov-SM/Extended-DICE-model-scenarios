...
file results1 /OM_Welfare.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put J.l(t));
putclose;

file results2 /OM_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /OM_YNET.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put YNET.l(t));
putclose;

file results4 /OM_DAMFRAC.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put DAMFRAC.l(t));
putclose;

file results5 /OM_ABATEMENT_PART.csv/;     results5.nd = 10 ; results5.nw = 0 ; results5.pw=1200000; results5.pc=5;
put results5;
Loop (t, put MCABATE.l(t));
putclose;


file results55 /OM_CONSUMPTION.csv/;     results55.nd = 10 ; results55.nw = 0 ; results55.pw=1200000; results55.pc=5;
put results55;
Loop (t, put C.l(t));
putclose;

file results111 /OM_Discounted.csv/;     results111.nd = 10 ; results111.nw = 0 ; results111.pw=1200000; results111.pc=5;
put results111;
Loop (t, put PERIODU.l(t));
putclose;

file results1111 /OM_Inv.csv/;     results1111.nd = 10 ; results1111.nw = 0 ; results1111.pw=1200000; results1111.pc=5;
put results1111;
Loop (t, put I.l(t));
putclose;
file results11111 /OM_CPC.csv/;     results11111.nd = 10 ; results11111.nw = 0 ; results11111.pw=1200000; results11111.pc=5;
put results11111;
Loop (t, put CPC.l(t));
putclose;
...
Parameter PLOT_9 data for plotter;
 PLOT_9("graph",t,"RI")=RI.l(t);
 PLOT_9("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_9 t RI
...
Parameter PLOT_3 data for plotter;
 PLOT_3("graph",t,"MAT")=MAT.l(t);
 PLOT_3("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_3 t MAT
