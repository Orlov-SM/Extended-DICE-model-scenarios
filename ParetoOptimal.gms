...
file results /Welfare_Opt_with_constr.csv/;     results.nd = 10 ; results.nw = 0 ; results.pw=1200000; results.pc=5;
put results;
Loop (t, put J.l(t));
putclose;
$offtext
file results1 /POM_Welfare.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put J.l(t));
putclose;

file results2 /POM_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /POM_YNET.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put YNET.l(t));
putclose;

file results4 /POM_DAMFRAC.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put DAMFRAC.l(t));
putclose;

file results5 /POM_ABATEMENT_PART.csv/;     results5.nd = 10 ; results5.nw = 0 ; results5.pw=1200000; results5.pc=5;
put results5;
Loop (t, put MCABATE.l(t));
putclose;
file results111 /POM_Discounted.csv/;     results111.nd = 10 ; results111.nw = 0 ; results111.pw=1200000; results111.pc=5;
put results111;
Loop (t, put PERIODU.l(t));
putclose;
file results55 /POM_CONSUMPTION.csv/;     results55.nd = 10 ; results55.nw = 0 ; results55.pw=1200000; results55.pc=5;
put results55;
Loop (t, put C.l(t));
putclose;
file results11111 /POM_CPC.csv/;     results11111.nd = 10 ; results11111.nw = 0 ; results11111.pw=1200000; results11111.pc=5;
put results11111;
Loop (t, put CPC.l(t));
putclose;
...
Parameter PLOT_1 data for plotter;
 PLOT_1("graph",t,"S")=S.l(t);
 PLOT_1("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_1 t S

Parameter PLOT_3 data for plotter;
 PLOT_3("graph",t,"RI")=RI.l(t);
 PLOT_3("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_3 t RI
Parameter PLOT_4 data for plotter;
 PLOT_4("graph",t,"ABATECOST")=ABATECOST.l(t);
 PLOT_4("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_4 t ABATECOST
