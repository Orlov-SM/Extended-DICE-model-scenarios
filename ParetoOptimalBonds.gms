...
** Population and technology
        ...
        rB       Bonds rate of return (per year)                  /.022    /
...
VARIABLES
        ...
        cons(t) distance in thousands of miles
$GDXIN NM_CONSUMPTION.gdx
$LOAD  cons=C
$GDXIN
        cons2(t) distance in thousands of miles
$GDXIN OM_CONSUMPTION.gdx
$LOAD  cons2=C
$GDXIN
;
...
CONSEQ(t)..           C(t)           =G= CONS(t);
CONSEQ2(t)..           C(t)           =G= CONS2(t);
...
$offtext
file results /PMB_TAX_PART.csv/;     results.nd = 10 ; results.nw = 0 ; results.pw=1200000; results.pc=5;
put results;
Loop (T, put tau.l(T));
putclose;

file results1 /PMB_Welfare.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put J.l(t));
putclose;

file results2 /PMB_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /PMB_YNET.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put YNET.l(t));
putclose;

file results4 /PMB_DAMFRAC.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put DAMFRAC.l(t));
putclose;

file results5 /PMB_ABATEMENT_PART.csv/;     results5.nd = 10 ; results5.nw = 0 ; results5.pw=1200000; results5.pc=5;
put results5;
Loop (t, put MCABATE.l(t));
putclose;

file results6 /PMB_BONDS.csv/;     results6.nd = 10 ; results6.nw = 0 ; results6.pw=1200000; results6.pc=5;
put results6;
Loop (T, put B.l(T));
putclose;

file results111 /PMB_Discounted.csv/;     results111.nd = 10 ; results111.nw = 0 ; results111.pw=1200000; results111.pc=5;
put results111;
Loop (t, put PERIODU.l(t));
putclose;

file results11111 /PMB_CPC.csv/;     results11111.nd = 10 ; results11111.nw = 0 ; results11111.pw=1200000; results11111.pc=5;
put results11111;
Loop (t, put CPC.l(t));
putclose;
...
Parameter PLOT_5 data for plotter;
 PLOT_5("graph",t,"TAXCOST")=TAXCOST.l(t);
 PLOT_5("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_5 t TAXCOST
