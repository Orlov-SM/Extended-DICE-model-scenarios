...
** Population and technology
        ...
        rB       Bonds rate of return (per year)                  /.03    /
...
NONNEGATIVE VARIABLES  MIU, TATM, MAT, MU, ML, Y, YGROSS, C, K, I, B;
...
*Economic variables
 ...
 taxeq(t)..           TAXCOST(t)     =E= YNET(t) * tau(t);
 yy(t)..              Y(t)           =E= YNET(t) - TAXCOST(t);
 cc(t)..              C(t)           =E= Y(t) - I(t);
...
file results /tau.csv/;     results.nd = 10 ; results.nw = 0 ; results.pw=1200000; results.pc=5;
put results;
Loop (T, put tau.l(T));
putclose;

file results2 /abatement_part.csv/;     results.nd = 10 ; results.nw = 0 ; results.pw=1200000; results.pc=5;
put results2;
Loop (t, put MCABATE.l(t));
putclose;
$offtext
file results /OMB_TAX_PART.csv/;     results.nd = 10 ; results.nw = 0 ; results.pw=1200000; results.pc=5;
put results;
Loop (T, put tau.l(T));
putclose;

file results1 /OMB_Welfare.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put J.l(t));
putclose;

file results2 /OMB_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /OMB_YNET.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put YNET.l(t));
putclose;

file results4 /OMB_DAMFRAC.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put DAMFRAC.l(t));
putclose;

file results5 /OMB_ABATEMENT_PART.csv/;     results5.nd = 10 ; results5.nw = 0 ; results5.pw=1200000; results5.pc=5;
put results5;
Loop (t, put MCABATE.l(t));
putclose;

file results6 /OMB_BONDS.csv/;     results6.nd = 10 ; results6.nw = 0 ; results6.pw=1200000; results6.pc=5;
put results6;
Loop (T, put B.l(T));
putclose;

file results111 /OMB_Discounted.csv/;     results111.nd = 10 ; results111.nw = 0 ; results111.pw=1200000; results111.pc=5;
put results111;
Loop (t, put PERIODU.l(t));
putclose;

file results55 /OMB_CONSUMPTION.csv/;     results55.nd = 10 ; results55.nw = 0 ; results55.pw=1200000; results55.pc=5;
put results55;
Loop (t, put C.l(t));
putclose;

file results11111 /OMB_CPC.csv/;     results11111.nd = 10 ; results11111.nw = 0 ; results11111.pw=1200000; results11111.pc=5;
put results11111;
Loop (t, put CPC.l(t));
putclose;
...
Parameter PLOT_4 data for plotter;
 PLOT_4("graph",t,"tau")=tau.l(t);
 PLOT_4("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_4 t tau

Parameter PLOT_44 data for plotter;
 PLOT_44("graph",t,"C")=C.l(t);
 PLOT_44("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_44 t C




Parameter PLOT_2 data for plotter;
 PLOT_2("graph",t,"BY")=B.l(t)/YNET.l(t);
 PLOT_2("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_2 t BY




Parameter PLOT_5 data for plotter;
 PLOT_5("graph",t,"RI")=RI.l(t);
 PLOT_5("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_5 t RI
...
Parameter PLOT_6 data for plotter;
 PLOT_6("graph",t,"ABATECOST/YGROSS")=ABATECOST.l(t)/YGROSS.l(t);
 PLOT_6("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_6 t ABATECOST/YGROSS

Parameter PLOT_7 data for plotter;
 PLOT_7("graph",t,"TAU")=tau.l(t);
 PLOT_7("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_7 t TAU

Parameter PLOT_8 data for plotter;
 PLOT_8("graph",t,"YNET")=YNET.l(t);
 PLOT_8("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_8 t YNET

Parameter PLOT_9 data for plotter;
 PLOT_9("graph",t,"DAMFRAC")=DAMFRAC.l(t);
 PLOT_9("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_9 t DAMFRAC

Parameter PLOT_10 data for plotter;
 PLOT_10("graph",t,"J")=J.l(t);
 PLOT_10("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_10 t J
$exit
