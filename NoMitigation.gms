...
Execute_Unload 'NM_CONSUMPTION.gdx',C;
$ontext



$offtext
file results1 /NM_Welfare.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put J.l(t));
putclose;

file results2 /NM_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /NM_YNET.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put YNET.l(t));
putclose;

file results4 /NM_DAMFRAC.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put DAMFRAC.l(t));
putclose;

file results5 /NM_CONSUMPTION.csv/;     results5.nd = 10 ; results5.nw = 0 ; results5.pw=1200000; results5.pc=5;
put results5;
Loop (t, put C.l(t));
putclose;

file results111 /NM_Discounted.csv/;     results111.nd = 10 ; results111.nw = 0 ; results111.pw=1200000; results111.pc=5;
put results111;
Loop (t, put PERIODU.l(t));
putclose;

file results1111 /NM_Inv.csv/;     results1111.nd = 10 ; results1111.nw = 0 ; results1111.pw=1200000; results1111.pc=5;
put results1111;
Loop (t, put I.l(t));
putclose;

file results11111 /NM_CPC.csv/;     results11111.nd = 10 ; results11111.nw = 0 ; results11111.pw=1200000; results11111.pc=5;
put results11111;
Loop (t, put CPC.l(t));
putclose;
...
Parameter PLOT_1 data for plotter;
 PLOT_1("graph",t,"RI")=RI.l(t);
 PLOT_1("graph",t,"t")=ord(t);

$libinclude gnuplotxyz PLOT_1 t RI
